...
public class Solution {
    ...
    public static int getMaxProfit(int[] stockPrices) {
		...
		int current_index=1;
		int best_profit=-9999999;
		int current_value=stockPrices[0];
		while (current_index < stockPrices.length) {
            if (stockPrices[current_index] - current_value > best_profit) {
                best_profit = stockPrices[current_index] - current_value ;
            }
            if (stockPrices[current_index] < current_value) {
                current_value = stockPrices[current_index] ;
            }
            current_index += 1 ;
        }
		return best_profit;
